...
def anelastic_attenuation(magnitude, distances, quality, static_stress_drop=1,
    ...
    :param static_stress_drop: static stress drop
    :param acceleration: true if simulation domain is acceleration
    :return: a list of magnitudes, attenuations and distances
    """
    from scipy import interpolate
    outlist = []
    seis = synthetic_seismogram(magnitude, static_stress_drop=static_stress_drop, duration=0.2, vp=vp,
...
def step_1(params, sc):
    ...
    static_stress_drop = simulparams.static_stress_drop
    try:
    ...
    if vmodel.homogeneous:
        ...
        sta_ = sta_interp_func(magnitudes, static_stress_drop, vp, vs, rho, acceleration)
    else:
        ...
        sta_ = sta_interp_func(magnitudes, static_stress_drop, np.mean(vp), np.mean(vs),
    ...
    for station in scenario.site.stations():
        ...
        #     print k_
        #     detection_threshold(evtp, station.loc, stalta_th, static_stress_drop, noise,
        ...
        f = lambda evtp: detection_threshold(evtp, station.loc, stalta_th,
                                             ...
                                             vmodel.homogeneous, triaxial,
                                             orientation, magnitudes, sta_,
                                             static_stress_drop, quality, a_s_att_fun)
